...
// {
	...
	// --checkConsistency --dependencyAnalysis="weirdNodes". This is the first
	// commit (da-slayers-5adeeafc0) in the scion-slayers progress eval where
	// the crash occurs; the previous commit (da-slayers-3395993ea) verified
	// this exact method fine, so it is a toolchain-crash workaround, not a
	// genuine regression.
