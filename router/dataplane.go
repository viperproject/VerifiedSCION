...
func (p *scionPacketProcessor) parsePath( /*@ ghost ub []byte @*/ ) (respr processResult, reserr error) {
	...
	// @ assert reveal p.path.EqAbsInfoField(p.path.absPkt(sl.View(ubPath, 0, len(ubPath))),
	// @ 	p.infoField.ToAbsInfoField())
	// @ assert reveal p.path.EqAbsHopField(p.path.absPkt(sl.View(ubPath, 0, len(ubPath))),
	// @ 	p.hopField.Abs())
...
func (p *scionPacketProcessor) validateSrcDstIA( /*@ ghost ubScionL []byte, ghost ubLL []byte, ghost startLL int, ghost endLL int @*/ ) (respr processResult, reserr error) {
	...
	// @ p.scionLayer.ValidHeaderOffsetToSubSliceLemma(ubScionL, sl.View(ubScionL, 0, len(ubScionL)), startP)
	...
	if p.ingressID == 0 {
		...
		// @ 	p.scionLayer.ValidHeaderOffsetFromSubSliceLemma(ubScionL, sl.View(ubScionL, 0, len(ubScionL)), startP)
...
func (p *scionPacketProcessor) processEgress( /*@ ghost ub []byte @*/ ) (reserr error) {
	...
	// @ reveal p.EqAbsHopField(absPkt(sl.View(ub, 0, len(ub))))
	// @ sl.SplitRange_Bytes(ub, startP, endP, HalfPerm)
	// @ reveal p.scionLayer.ValidHeaderOffset(ub, sl.View(ub, 0, len(ub))[:startP])
	...
	// @ assert reveal p.scionLayer.ValidHeaderOffset(ub, sl.View(ub, 0, len(ub))[:startP])
...
func (p *scionPacketProcessor) doXover( /*@ ghost ub []byte, ghost currBase scion.Base @*/ ) (respr processResult, reserr error) {
	...
	// @ assert p.path == p.scionLayer.GetPath(ub)
	// @ p.scionLayer.ValidHeaderOffsetToSubSliceLemma(ub, sl.View(ub, 0, len(ub)), startP)
	// @ ghost preAbsPkt := p.path.absPkt(sl.View(ubPath, 0, len(ubPath)))
	...
	// @ assert reveal p.path.EqAbsHopField(p.path.absPkt(sl.View(ubPath, 0, len(ubPath))), p.hopField.Abs())
	// @ assert reveal p.EqAbsHopField(absPkt(sl.View(ub, 0, len(ub))))
	// @ assert reveal p.EqAbsInfoField(absPkt(sl.View(ub, 0, len(ub))))
	// @ ghost sl.CombineRange_Bytes(ub, startP, endP, HalfPerm/2)
	// @ fold acc(p.scionLayer.Mem(ub), 1-R55)
